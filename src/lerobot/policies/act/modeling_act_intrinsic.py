...
from lerobot.policies.act.configuration_act import ACTIntrinsicConfig
...
class ACTIntrinsicPolicy(ACTPolicy):
    config_class = ACTIntrinsicConfig
    name = "act_intrinsic"

    def __init__(self, config: ACTIntrinsicConfig, **kwargs):
        super().__init__(config, **kwargs)
        apply_intrinsic_dimension_subspace(self.model, config.intrinsic_dim)
